		...
		getSelected: function() {
			...
			switch (type) {
				...
				case 'hour':
					...
					break;
				case 'day':
				    selected.value = selected.m.value + '-' + selected.d.value + ' ' + selected.h.value + ' ' + selected.i.value;
				    selected.text = selected.m.text + '-' + selected.d.text + ' ' + selected.h.text + ' ' + selected.i.text;
				  	break;
			}
			return selected;
		},
